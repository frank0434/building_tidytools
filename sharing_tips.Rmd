...
![Snapshot from the Material - `03-test`](C:/Users/cflfcl/Desktop/mindbox/sharing/Picture3.PNG)
...
![Snapshot from the Material - `09-document`](C:/Users/cflfcl/Desktop/mindbox/sharing/Picture4.PNG)




![Snapshot from the Material - `04-api-design`](C:/Users/cflfcl/Desktop/mindbox/sharing/Picture5.PNG)



Why bother to spend heaps of time to develop something that is already existing and well deveoped. It might be sounds cool to develop everything on my own. However, there is a great cost on this, time. I am only an amture R programmer and R is a tool to help me understand the data. 


I believe that the key of learning R is achieve something small everyday. Starting is always hard. I still remember the frustition that I first start to use R 
